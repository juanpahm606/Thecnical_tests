...
def selenium(browser,downloadpath):
    ...
    for i in range(1,121): #Una tabla con columans para el año y cada categoría de los Nobel
        ...
        A_text=Age.text #Convierte el valor encontrado en texto, las varianles tienen el nombre de cada categoría del premio Nobel
    ...
    pass
#Pasamos los valores del diccionario a un Dataframe

df2=pd.DataFrame.from_dict(df)
df2.to_csv(final_path + "\\premios_nobel.csv",sep=';',index=False) #Guarda los datos en un CSV
